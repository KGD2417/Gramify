...
public class AdapterPosts extends RecyclerView.Adapter<in.social.gramify.AdapterPosts.MyHolder> {
    ...
    public AdapterPosts(Context context, List<ModelPost> modelPosts) {
        ...
        liekeref = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Likes");
        postref = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference().child("Posts");
    }
    ...
    private void deltewithImage(final String pid, String image) {
        ...
        picref.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                Query query = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Posts").orderByChild("ptime").equalTo(pid);
