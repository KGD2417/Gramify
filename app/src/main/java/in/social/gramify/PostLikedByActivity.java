...
//        actionBar.setSubtitle(firebaseAuth.getCurrentUser().getEmail());
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Likes");
    ...
    private void getUsers(String hisUid) {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Users");
