        ...
        builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!TextUtils.isEmpty(value)) {
                    ...
                    if (key.equals("name")) {
                        final DatabaseReference databaser = FirebaseDatabase.getInstance("https://gramify-2fce3-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference("Posts");
